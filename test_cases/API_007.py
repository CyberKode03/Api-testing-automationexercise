# TC07_post_verify_login_valid.py
import http.client

def run_test():
    print("Running TC07: POST /verifyLogin with valid credentials")
    logs = []
    status_code = None

    try:
        conn = http.client.HTTPSConnection("automationexercise.com")
        payload = 'email=devadigakarthik%40gmail.com&password=Tester%401234'
        headers = {
